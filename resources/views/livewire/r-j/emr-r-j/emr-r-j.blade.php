<div>
    ...
    Main BgColor /
    Size H/W --}}
    <livewire:component.cetak.cetak-surat-rujukan :rjNoRef="2413" :wire:key="$rjNoRef.'cetak-surat-rujukan'">
        <div class="w-full h-[calc(100vh-68px)] bg-white border border-gray-200 px-4 pt-6">
            ...
            <div class="flex justify-between">
                ...
                <div class="flex justify-end w-1/2">
                    <livewire:r-j.emr-r-j.post-encounter-r-j.post-encounter-r-j-all :rjDateRef="$myTopBar['refDate']"
                                        ...
                                        <livewire:component.cetak.cetak-etiket :regNo="$myQData->reg_no"
                                            ...
                                            @role(['Admin', 'Mr', 'Perawat'])
                                                <div class="grid grid-cols-1 gap-2">
                                                    <livewire:r-j.emr-r-j.post-encounter-r-j.post-encounter-r-j
