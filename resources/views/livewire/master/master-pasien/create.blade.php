                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <form class="scroll-smooth hover:scroll-auto">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center mb-2">
                                        <x-text-input placeholder="Gelar depan" class="mt-1 ml-2 sm:w-1/4"
                                            :errorshas="__($errors->has('dataPasien.pasien.gelarDepan'))" :disabled=$disabledProperty
                                        ...
                                        <x-text-input placeholder="Gelar Belakang" class="mt-1 ml-2 sm:w-1/4"
                                            :errorshas="__($errors->has('dataPasien.pasien.gelarBelakang'))" :disabled=$disabledProperty
                                        ...
                                        <x-text-input placeholder="Nama Panggilan" class="mt-1 ml-2 sm:w-1/4"
                                            :errorshas="__($errors->has('dataPasien.pasien.namaPanggilan'))" :disabled=$disabledProperty :disabled=$disabledProperty
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center mb-2">
                                        <x-text-input id="tempatLahir" placeholder="Tempat Lahir"
                                            class="mt-1 ml-2 sm:w-1/2" :errorshas="__($errors->has('dataPasien.pasien.tempatLahir'))" :disabled=$disabledProperty
                                        ...
                                        <x-text-input placeholder="Umur Thn" class="mt-1 ml-2 sm:w-1/6"
                                            :errorshas="__($errors->has('dataPasien.pasien.thn'))" :disabled=$disabledProperty
                                            wire:model.debounce.500ms="dataPasien.pasien.thn" />
                                        <x-text-input placeholder="Umur Bln" class="mt-1 ml-2 sm:w-1/6"
                                            :errorshas="__($errors->has('dataPasien.pasien.bln'))" :disabled=$disabledProperty
                                            wire:model.debounce.500ms="dataPasien.pasien.bln" />
                                        <x-text-input placeholder="Umur Hari" class="mt-1 ml-2 sm:w-1/6"
                                            :errorshas="__($errors->has('dataPasien.pasien.hari'))" :disabled=$disabledProperty
                                ...
                                <x-border-form :title="__('Sosial')" :align="__('start')" :bgcolor="__('bg-gray-50')">
                                    <div class="flex items-center">
                                        <x-input-label for="JenisKelamin" :value="__('Jenis Kelamin')" :required="__($errors->has('dataPasien.pasien.jenisKelamin.jenisKelaminId'))"
                                            class="sm:w-1/5" />
                                        <x-input-label for="Agama" :value="__('Agama')" :required="__($errors->has('dataPasien.pasien.agama.agamaId'))"
                                            class="sm:w-1/5" />
                                        ...
                                        <x-input-label for="Pendidikan" :value="__('Pendidikan')" :required="__($errors->has('dataPasien.pasien.pendidikan.pendidikanId'))"
                                            class="sm:w-1/5" />
                                        <x-input-label for="Pekerjaan" :value="__('Pekerjaan')" :required="__($errors->has('dataPasien.pasien.pekerjaan.pekerjaanId'))"
                                            class="sm:w-1/5" />
                                    </div>
                                    ...
                                    <div class="flex items-center mb-2">
                                        ...
                                        <div class="mt-1 sm:w-1/5">
                                            ...
                                            {{-- LOV jenisKelamin --}}
                                            @include('livewire.master.master-pasien.list-of-value-jenisKelamin')
                                        </div>

                                        <div class="mt-1 ml-2 sm:w-1/5">
                                            <div class="flex ">
                                                <x-text-input placeholder="Agama"
                                                    class="sm:rounded-none sm:rounded-l-lg" :errorshas="__($errors->has('dataPasien.pasien.agama.agamaId'))"
                                                    :disabled=true
                                            ...
                                            {{-- LOV agama --}}
                                            @include('livewire.master.master-pasien.list-of-value-agama')
                                        </div>
                                        ...
                                        <div class="mt-1 ml-2 sm:w-1/5">
                                            ...
                                            @include('livewire.master.master-pasien.list-of-value-statusPerkawinan')
                                        </div>
                                        ...
                                        <div class="mt-1 ml-2 sm:w-1/5">
                                            <div class="flex ">
                                                <x-text-input placeholder="Pendidikan"
                                                    class="sm:rounded-none sm:rounded-l-lg" :errorshas="__(
                                                        $errors->has('dataPasien.pasien.pendidikan.pendidikanId'),
                                                    )"
                                                    :disabled=true
                                            ...
                                            {{-- LOV pendidikan --}}
                                            @include('livewire.master.master-pasien.list-of-value-pendidikan')
                                        </div>
                                        ...
                                        <div class="mt-1 ml-2 sm:w-1/5">
                                            <div class="flex ">
                                                <x-text-input placeholder="pekerjaan"
                                                    class="sm:rounded-none sm:rounded-l-lg" :errorshas="__(
                                                        $errors->has('dataPasien.pasien.pekerjaan.pekerjaanId'),
                                                    )"
                                                    :disabled=true
                                            ...
                                            {{-- LOV pekerjaan --}}
                                            @include('livewire.master.master-pasien.list-of-value-pekerjaan')
                                        </div>
                                    </div>
                                    {{-- Error Message Start --}}
                                    <div class="flex items-center mb-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center mb-2">
                                            ...
                                            <div class="mt-1 ml-2 sm:w-1/5">
                                                ...
                                                {{-- LOV golonganDarah --}}
                                                @include('livewire.master.master-pasien.list-of-value-golonganDarah')
                                            </div>

                                            <x-text-input id="Kewarganegaraan" placeholder="Kewarganegaraan"
                                                class="mt-1 ml-2 sm:w-1/5" :errorshas="__($errors->has('dataPasien.pasien.kewarganegaraan'))"
                                                :disabled=$disabledProperty
                                                wire:model.debounce.500ms="dataPasien.pasien.kewarganegaraan" />

                                            <x-text-input id="Suku" placeholder="Suku"
                                                class="mt-1 ml-2 sm:w-1/4" :errorshas="__($errors->has('dataPasien.pasien.suku'))"
                                                :disabled=$disabledProperty
                                                wire:model.debounce.500ms="dataPasien.pasien.suku" />

                                            <x-text-input id="Bahasa" placeholder="Bahasa yang digunakan"
                                                class="mt-1 ml-2 sm:w-1/5" :errorshas="__($errors->has('dataPasien.pasien.bahasa'))"
                                                :disabled=$disabledProperty
                                            ...
                                            <div class="mt-1 ml-2 sm:w-1/5">
                                                <div class="flex ">
                                                    <x-text-input placeholder="status"
                                                        class="sm:rounded-none sm:rounded-l-lg" :errorshas="__(
                                                            $errors->has('dataPasien.pasien.status.statusId'),
                                                        )"
                                                        :disabled=true
                                                ...
                                                {{-- LOV status --}}
                                                @include('livewire.master.master-pasien.list-of-value-status')
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-4 gap-2">
                                            <div class="flex items-center col-span-3 mb-2">
                                                <x-text-input id="UUIDidentitas" placeholder="patientUuid"
                                                    class="mt-1 ml-2" :errorshas="__(
                                                        $errors->has('dataPasien.pasien.identitas.patientUuid'),
                                                    )" :disabled=true
                                        ...
                                        <div>
                                            <div>
                                                <x-input-label for="nikidentitas" :value="__('NIK')"
                                                    :required="__($errors->has('dataPasien.pasien.identitas.nik'))" />

                                                <div class="grid grid-cols-4 gap-2">
                                                    <div class="flex items-center col-span-3 mb-2">
                                                        <x-text-input id="nikidentitas" placeholder="NIK"
                                                            class="mt-1 ml-2" :errorshas="__(
                                                                $errors->has('dataPasien.pasien.identitas.nik'),
                                                            )"
                                                            :disabled=$disabledProperty
                                                            wire:model.debounce.500ms="dataPasien.pasien.identitas.nik" />
                                                    </div>

                                                    <div wire:loading wire:target="cekNIKBpjs">
                                                        <x-loading />
                                                    </div>

                                                    <x-yellow-button :disabled=$disabledProperty
                                                        wire:click.prevent="cekNIKBpjs('{{ $dataPasien['pasien']['identitas']['nik'] }}')"
                                                        type="button" wire:loading.remove>
                                                        NIIK
                                                    </x-yellow-button>
                                                </div>
                                            ...
                                            <div>
                                                <x-input-label for="idBpjsidentitas" :value="__('Id BPJS')"
                                                    :required="__($errors->has('dataPasien.pasien.identitas.idBpjs'))" />
                                                ...
                                                <div class="grid grid-cols-4 gap-2">
                                                    <div class="flex items-center col-span-3 mb-2">
                                                        <x-text-input id="idBpjsidentitas"
                                                            ...
                                                            :errorshas="__(
                                                                $errors->has('dataPasien.pasien.identitas.idBpjs'),
                                                            )" :disabled=$disabledProperty
                                                            wire:model.debounce.500ms="dataPasien.pasien.identitas.idBpjs" />
                                                    </div>

                                                    <div wire:loading wire:target="ceKIdBprjs">
                                                        <x-loading />
                                                    </div>
                                            ...
                                            <div>
                                                <x-input-label for="pasporidentitas" :value="__('Paspor')"
                                                    :required="__($errors->has('dataPasien.pasien.identitas.pasport'))" />
                                                <div class="flex items-center mb-2">
                                                    <x-text-input id="pasporidentitas"
                                                        placeholder="Paspor [untuk WNA / WNI]" class="mt-1 ml-2"
                                                        :errorshas="__(
                                                            $errors->has('dataPasien.pasien.identitas.pasport'),
                                                        )" :disabled=$disabledProperty
                                            ...
                                            <div>
                                                <x-input-label for="Alamatidentitas" :value="__('Alamat')"
                                                    :required="__($errors->has('dataPasien.pasien.identitas.alamat'))" />
                                                <div class="flex items-center mb-2">
                                                    <x-text-input id="Alamatidentitas" placeholder="Alamat"
                                                        class="mt-1 ml-2" :errorshas="__(
                                                            $errors->has('dataPasien.pasien.identitas.alamat'),
                                                        )"
                                                        :disabled=$disabledProperty
                                            ...
                                            <div>
                                                <x-input-label for="rtrwidentitas" :value="__('RT/RW')"
                                                    :required="__($errors->has('dataPasien.pasien.identitas.rt'))" />
                                                <div class="flex items-center mb-2">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <x-input-label for="kotaidentitas" :value="__('kota')"
                                                    :required="__($errors->has('dataPasien.pasien.identitas.kotaId'))" />
                                                ...
                                                <div class="mt-1">
                                                    ...
                                                    <div class="flex mb-2 ml-2 ">
                                                        <x-text-input placeholder="kota"
                                                            class="sm:rounded-none sm:rounded-l-lg" :errorshas="__(
                                                                $errors->has('dataPasien.pasien.identitas.kotaId'),
                                                            )"
                                                            :disabled=true
                                                    ...
                                                    {{-- LOV hubunganDgnPasien --}}
                                                    @include('livewire.master.master-pasien.list-of-value-kotaIdentitas')
                                                </div>
                                            ...
                                            <div>
                                                <x-input-label for="Propinsiidentitas" :value="__('Propinsi')"
                                                    :required="__(
                                                        $errors->has('dataPasien.pasien.identitas.propinsiId'),
                                                    )" />
                                                <div class="flex items-center mb-2">
                                            ...
                                            <div>
                                                <x-input-label for="negaraidentitas" :value="__('Negara')"
                                                    :required="__($errors->has('dataPasien.pasien.identitas.negara'))" />
                                                <div class="flex items-center mb-2">
                                                    <x-text-input id="negaraidentitas"
                                                        placeholder="Negara [isi dgn ID]" class="mt-1 ml-2"
                                                        :errorshas="__(
                                                            $errors->has('dataPasien.pasien.identitas.negara'),
                                                        )" :disabled=$disabledProperty
                                ...
                                <x-border-form :title="__('Alamat Domisil')" :align="__('start')" :bgcolor="__('bg-gray-50')" class="">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            ...
                                            <div class="flex mb-2 ml-2 ">
                                                <x-text-input placeholder="Desa"
                                                    class="sm:rounded-none sm:rounded-l-lg" :errorshas="__($errors->has('dataPasien.pasien.domisil.desaId'))"
                                                    :disabled=true
                                            ...
                                            {{-- LOV hubunganDgnPasien --}}
                                            @include('livewire.master.master-pasien.list-of-value-desaDomisil')
                                        </div>
                                    ...
                                    <div>
                                        <x-input-label for="KecamatanDomisil" :value="__('Kecamatan')"
                                            :required="__($errors->has('dataPasien.pasien.domisil.kecamatanId'))" />
                                        <div class="flex items-center mb-2">
                                            <x-text-input id="KecamatanDomisil" placeholder="Kecamatan"
                                                class="mt-1 ml-2" :errorshas="__($errors->has('dataPasien.pasien.domisil.kecamatanId'))" :disabled=true
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center mb-2">
                                        <x-text-input placeholder="No HP" class="mt-1 ml-2 sm:w-16"
                                            :errorshas="__($errors->has('dataPasien.pasien.kontak.kodenegara'))" :disabled=$disabledProperty
                                        ...
                                        <x-text-input id="nohpPasien" placeholder="No HP" class="mt-1 ml-2 "
                                            :errorshas="__(
                                                $errors->has('dataPasien.pasien.kontak.nomerTelponSelulerPasien'),
                                            )" :disabled=$disabledProperty
                            ...
                            <x-border-form :title="__('Hubungan')" :align="__('start')" :bgcolor="__('bg-gray-50')" class="">
                                ...
                                <x-border-form :title="__('Penanggung Jawab')" :align="__('start')" :bgcolor="__('bg-yellow-100')">
                                    ...
                                    <div class="flex items-center mb-2">
                                        <x-text-input id="PenanggungJawab" placeholder="Nama Penanggung Jawab"
                                            class="mt-1 ml-2" :errorshas="__(
                                                $errors->has('dataPasien.pasien.hubungan.namaPenanggungJawab'),
                                            )" :disabled=$disabledProperty
                                            wire:model.debounce.500ms="dataPasien.pasien.hubungan.namaPenanggungJawab"
                                            style="text-transform:uppercase" />
                                        <x-text-input placeholder="No HP" class="mt-1 ml-2 sm:w-16"
                                            :errorshas="__(
                                                $errors->has('dataPasien.pasien.hubungan.kodenegaraPenanggungJawab'),
                                            )" :disabled=$disabledProperty
                                    ...
                                    <div class="mt-1 mb-2 sm:w-1/2">
                                        ...
                                        {{-- LOV hubunganDgnPasien --}}
                                        @include('livewire.master.master-pasien.list-of-value-hubunganDgnPasien')
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center mb-2">
                                        <x-text-input id="Ayah" placeholder="Nama Ayah" class="mt-1 ml-2"
                                            ...
                                            style="text-transform:uppercase" />
                                        <x-text-input placeholder="No HP" class="mt-1 ml-2 sm:w-16"
                                            :errorshas="__($errors->has('dataPasien.pasien.hubungan.kodenegaraAyah'))" :disabled=$disabledProperty
                                            wire:model.debounce.500ms="dataPasien.pasien.hubungan.kodenegaraAyah" />
                                        <x-text-input id="nohpTelponLain" placeholder="No HP" class="mt-1 ml-2 "
                                            :errorshas="__(
                                                $errors->has('dataPasien.pasien.hubungan.nomerTelponSelulerAyah'),
                                            )" :disabled=$disabledProperty
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center mb-2">
                                        ...
                                        <x-text-input placeholder="No HP" class="mt-1 ml-2 sm:w-16"
                                            :errorshas="__($errors->has('dataPasien.pasien.hubungan.kodenegaraIbu'))" :disabled=$disabledProperty
                                            wire:model.debounce.500ms="dataPasien.pasien.hubungan.kodenegaraIbu"
                                            style="text-transform:uppercase" />
                                        <x-text-input id="nohpTelponLain" placeholder="No HP" class="mt-1 ml-2 "
                                            :errorshas="__(
                                                $errors->has('dataPasien.pasien.hubungan.nomerTelponSelulerIbu'),
                                            )" :disabled=$disabledProperty
                        ...
                        <div class="sticky bottom-0 px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
                            @if ($isOpenMode !== 'tampil')
                                <x-green-button :disabled=$disabledProperty wire:click.prevent="store()"
                                    type="button">Simpan
                                </x-green-button>
                            @endif
                    ...
                    <div>
                        <livewire:penunjang.emr.rekam-medis.rekam-medis :wire:key="'content-rekamMedisRj'"
                            :regNoRef="$dataPasien['pasien']['regNo'] ?? ''">
                    </div>
