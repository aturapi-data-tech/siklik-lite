        ...
        <div class="fixed inset-0 transition-opacity">
            <div class="absolute overflow-auto bg-white rounded-t-lg inset-4">
                ...
                <div class="grid grid-cols-1">
                    <livewire:master.master-ref-bpjs.form-entry-ref-bpjs.form-entry-ref-bpjs :refBpjsId="$refBpjsId"
                        :isOpenMode="$isOpenMode" :wire:key="$refBpjsId.'form-entry-refBpjs'">
