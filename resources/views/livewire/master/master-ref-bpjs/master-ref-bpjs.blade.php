<div>
    ...
    <div class="w-full h-[calc(100vh-68px)] bg-white border border-gray-200 px-4 pt-6">
        ...
        <div class="flex justify-between">
            ...
            @if ($isOpen)
                @include('livewire.master.master-ref-bpjs.create')
            @endif
                        ...
                        <tr class="border-b group dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 group-hover:bg-gray-100 group-hover:text-primary">
                                ...
                                <div class="inline-flex">
                                    ...
                                    <div>
                                        <x-light-button id="dropdownButton{{ $myQData->ref_keterangan }}"
                                            class="inline-flex"
                                            wire:click="$emit('pressDropdownButton','{{ $myQData->ref_keterangan }}')">
                                        ...
                                        <div id="dropdownMenu{{ $myQData->ref_keterangan }}"
                                            class="z-10 hidden w-auto bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700">
                                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                aria-labelledby="dropdownButton{{ $myQData->ref_keterangan }}">
                                                {{-- <li>
                                                    <x-dropdown-link wire:click="tampil('{{ $myQData->ref_keterangan }}')">
                                                        {{ __('Tampil | ' . $myQData->ref_json) }}
                                                    </x-dropdown-link>
                                                </li> --}}
                                                <li>
                                                    <x-dropdown-link
                                                        wire:click="edit('{{ $myQData->ref_keterangan }}','{{ $myQData->ref_json }}')">
                                                        {{ __('Ubah') }}
                                                    </x-dropdown-link>
                                                </li>
                                                <li>
                                                    <x-dropdown-link
                                                        wire:click="delete('{{ $myQData->ref_keterangan }}','{{ $myQData->ref_json }}')">
                                                        {{ __('Hapus') }}
                                                    </x-dropdown-link>
                                                </li>
