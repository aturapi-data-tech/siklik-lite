<x-app-layout>
    ...
    <div>
        ...
        <div class="relative ">
            <div
                class="w-full h-[calc(100vh-68px)] bg-gradient-to-r from-green-500  from-10% via-green-500 via-30% to-green-500 to-90%border border-gray-200 px-4 pt-6 overflow-y-auto animate-bounce ">
            </div>
