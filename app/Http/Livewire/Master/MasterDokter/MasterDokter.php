...
namespace App\Http\Livewire\Master\MasterDokter;
...
class MasterDokter extends Component
{
    ...
    public function delete($dokterId, $dokterDesc): void
    {
        ...
        toastr()->closeOnHover(true)->closeDuration(3)->positionClass('toast-top-left')
            ->addSuccess("Data " . $dokterDesc . " berhasil dihapus.");
    }
    // open and close modal start////////////////
    ...
    public function render()
    {
        ...
        return view('livewire.master.master-dokter.master-dokter', ['myQueryData' => $query->paginate($this->limitPerPage)]);
    }
}
