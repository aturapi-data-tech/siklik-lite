...
namespace App\Http\Livewire\RJ\EmrRJ\DisplayPasien;
...
class DisplayPasien extends Component
{
    ...
    private function findData($rjno): void
    {
        ...
        if ($dataDaftarPoliRJ_json) {
            ...
            toastr()
                ...
                ->closeDuration(3)
                ->positionClass('toast-top-left')
                ->addError("Data tidak dapat di proses json.");
    ...
    {
        return view('livewire.r-j.emr-r-j.display-pasien.display-pasien');
    }
}
