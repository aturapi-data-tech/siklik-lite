...
namespace App\Http\Livewire\Penunjang\Emr\Laborat;
...
class Laborat extends Component
{
        ...
        if ($dataDaftarTxn) {
            if ($layananStatus === 'RJ') {
                ...
                toastr()
                    ...
                    ->addError('Rekam Medis (Rawat Inap) Fitur dalam masa pengembangan');
                // $this->dataDaftarTxn = $dataDaftarTxn;
    ...
    public function render()
    {
        ...
        return view(
            'livewire.penunjang.emr.laborat.laborat',
            [
